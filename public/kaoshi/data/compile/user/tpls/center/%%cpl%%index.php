						...
						<tr>
							<td width="30%">
								<div class="thumbnail" style="width:80%;">
									<img style="max-width:210px;" alt="300x200" src="<?php if($this->tpl_var['_user']['userphoto']){ ?><?php echo $this->tpl_var['_user']['userphoto']; ?><?php } else { ?>app/exam/styles/image/paper.png<?php } ?>" />
								</div>
							</td>
