            ...
            <div class="jianliBox">
                <div class="fl jian">
                    <ul>
                        {volist name="users" id="v"}
                        <li>
                            <div><a href="#"><{$v.info.name}></a><span
                                    class="time"><{$v.add_time|date='Y-m-d',###}></span></div>
                            <div><span><{$v.info.degree}></span><span class="ge">|</span><span><{$v.info.work_exprience}></span><span
                                    class="ge">|</span><span>技能：<{$v.info.skill}></span></div>
                        </li>
                        {/volist}
                    </ul>
                </div>
