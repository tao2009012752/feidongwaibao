...
<div class="main_box">
    ...
    <div class="cont_box">
        <form action="<{:url('importCompany/create')}>" method="post" id="formdata">
            <ul class="addpro_box adduser_box">
                <li>
                    <label><span class="red">*</span> 企业名称：</label>
                    <input type="text" placeholder="请输入企业名称" name="company_name" />
                </li>
                <li>
                ...
                <li>
                    ...
                    <script id="container3" name="another" type="text/plain" style="height:400px;float:left;width:800px"></script>
                </li>
                <li>
