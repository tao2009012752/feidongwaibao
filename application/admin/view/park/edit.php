...
<div class="main_box">
    ...
    <div class="cont_box">
        <form action="<{:url('park/edit',['park_id' => $detail['park_id']])}>" method="post" id="formdata">
            <ul class="addpro_box adduser_box">
                <li>
                    <label><span class="red">*</span> 园区名称：</label>
                    <input type="text" placeholder="请输入园区名称" name="park_name" value="<{$detail['park_name']}>" />
                </li>
                <li>
                ...
                <li>
                    ...
                    <script id="container3" name="basic_equipment" type="text/plain" style="height:400px;float:left;width:800px"><?=htmlspecialchars_decode($detail['basic_equipment'])?></script>
                </li>
                <li>
                    <label><span class="red">*</span> 投资环境：</label>
                    <script id="container4" name="environment" type="text/plain" style="height:400px;float:left;width:800px"><?=htmlspecialchars_decode($detail['environment'])?></script>
                </li>
                <li>
            ...
            <div class="probtn_box clearfix">
                <input type="submit" value="编辑园区" class="btn blue_btn"/>
            </div>
